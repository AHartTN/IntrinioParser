	...
	internal sealed class CompanyCSVMap : ClassMap<Company>
	{
		internal CompanyCSVMap()
		{
			...
			Map(m => m.HQAddress2)
				...
				.NameIndex(0)
				.Default(null);
			Map(m => m.HQAddressCity)
				.Name("HQ_ADDRESS_CITY")
				.NameIndex(0)
				.Default(null);
			Map(m => m.HQAddressPostalCode)
				.Name("HQ_ADDRESS_POSTAL_CODE")
				.NameIndex(0)
				.Default(null);
			Map(m => m.EntityLegalForm)
			...
			Map(m => m.CompanyURL)
				...
				.NameIndex(0)
				.Default(null);
			Map(m => m.BusinessAddress)
				.Name("BUSINESS_ADDRESS")
				.NameIndex(0)
				.Default(null);
			Map(m => m.MailingAddress)
				.Name("MAILING_ADDRESS")
				.NameIndex(0)
				.Default(null);
			Map(m => m.BusinessPhoneNo)
			...
			Map(m => m.Sector)
				...
				.NameIndex(0)
				.Default(null);
			Map(m => m.IndustryCategory)
				.Name("INDUSTRY_CATEGORY")
				.NameIndex(0)
				.Default(null);
			Map(m => m.IndustryGroup)
				.Name("INDUSTRY_GROUP")
				.NameIndex(0)
				.Default(null);
			Map(m => m.StandardizedActive)
